...
class _CrayonCustomerHomeScreenState extends State<CrayonHomeScreen> {
  ...
  String _getUserInitials() {
    if (username != null && username.contains(" ")) {
      ...
      return "${details[0].substring(0, 1).toString().toUpperCase()}${details[1]
  ...
  _buildMainUIWithLoading(BuildContext context,
  ...
  Future<bool> isExitFromApp() async{
    return await CrayonPaymentAlertDialogue.showMaterialAlert(
        context: context,
        isColumn: false,
        content: 'exit_the_app'.tr,
        cancelActionText: "ST_cancel".tr,
        defaultActionText: "OK".tr) ?? false;
  }
