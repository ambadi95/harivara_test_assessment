...
class WelcomeNavigationHandler with ErrorHandler {
  ...
  Future<void> navigateToOtpScreenCustomerSignUp(
    ...
    var arguments = OtpScreenArgs(
      ...
      false,
      userType,
        OTPEvent.Customer_Registration.toString().replaceAll("_", " ")
    );
    _navigationManager.navigateTo(
  ...
  Future<void> navigateToOtpScreenCustomerSignUpByAgent(
    ...
    var arguments = OtpScreenArgs(
      ...
      mobileNumber,
      false,
      userType, OTPEvent.Customer_Registration.toString().replaceAll("_", " ")
    );
    _navigationManager.navigateTo(
      CrayonVerifyOtpScreen.viewPath,
      const NavigationType.push(),
  ...
  Future<void> navigateToOtpScreenAgentResetPasscode(UserType userType, String agentId, String mobileNumber) async {
    var arguments = OtpScreenArgs(
      ...
      false,
      userType,
        OTPEvent.Reset_Passcode.toString().replaceAll("_", " ")
    );
  ...
  Future<void> navigateToOtpScreen(
    ...
    var arguments = OtpScreenArgs(
      ...
      false,
      userType,
        userType==UserType.Customer?OTPEvent.Customer_Login.toString().replaceAll("_", " "):OTPEvent.Agent_Login.toString().replaceAll("_", " ")
    );
  ...
  Future<void> navigateToOtpScreenCustomerResetPasscode(
    ...
    var arguments = OtpScreenArgs(
      ...
      mobileNumber,
      false,
      UserType.Customer, OTPEvent.Reset_Passcode.toString().replaceAll("_", " ")
    );
