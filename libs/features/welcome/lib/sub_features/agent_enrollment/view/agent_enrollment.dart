...
class AgentEnrollmentScreen extends StatefulWidget {
  static const viewPath = '${WelcomeModule.moduleIdentifier}/agentEnrollmentSuccess';
...
class _AgentEnrollmentScreenState extends State<AgentEnrollmentScreen> {
  @override
  Widget build(BuildContext context) => BaseView<AgentEnrollmentCoordinator, AgentEnrollmentState>(
  ...
  Widget _buildMainUI(
      AgentEnrollmentCoordinator coordinator
      ){
    return Padding(
  ...
  Widget _buildAgentHomeButton(
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Center(
          child: Text('AE_Continue'.tr, style: SU_button_text_style,),
        ),
      ),
    );
  }
