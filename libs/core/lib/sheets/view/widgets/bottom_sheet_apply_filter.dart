...
class BottomSheetApplyFilter extends StatelessWidget {
  static final String _identifier = 'BottomSheetApplyFilter';
  final ApplyFilterBottomSheet _sheetState;
  final CrayonPaymentBottomSheetCoordinator coordinator;

  const BottomSheetApplyFilter(
    this.coordinator,
    this._sheetState, {
    Key? key,
  }) : super(key: key);
