...
DeviceDetailsModel getMockupData = DeviceDetailsModel(
  imagePath: '',
  storage: '8GB / 128G',
  os: 'Android',
  price: 'TZS 1,870,000',
  ...
  chip: 'Exynos 2100',
  brand: 'Samsung',
  amountToPaid: 'TZS 1,000,000',
  cellularTechnology: 'GSM, EDGE, UMTS, HSPA, HSDPA, CDMA, EV-DO, LTE, 5G',
  colour: 'Lavender',
  humanInterfaceInput: 'Touchscreen',
  interest: '12.5%',
...
const List<DeviceDetailsModel> membershipBenefitsDataList = [
  ...
  DeviceDetailsModel(
    ...
    imagePath: 'assets/mb8.png',
  ),
  DeviceDetailsModel(
    model: 'DD_MemberBenefit9',
    imagePath: 'assets/mb9.png',
  ),
];
