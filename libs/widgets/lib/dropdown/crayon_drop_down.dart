...
const double _kMenuItemHeight = 50.0;

/// *[_kMenuItemHeight] which is dropdown item's default height

const EdgeInsets _kMenuItemPadding = EdgeInsets.symmetric(horizontal: 18.0);
...
const EdgeInsetsGeometry _kUnalignedMenuMargin =
    EdgeInsetsDirectional.only(start: 16, end: 0.0);
...
class CrayonDropDown<T> extends StatefulWidget {
  ...
  @override
  _CrayonDropDownState<T> createState() => _CrayonDropDownState<T>();
}

class _CrayonDropDownState<T> extends State<CrayonDropDown<T>>
  ...
  @override
  void didUpdateWidget(CrayonDropDown<T> oldWidget) {
