...
// in network_manager/test/utils/connectivity/connectivity_listener_test.dart.
...
class MockInternetAddressWrapper extends _i1.Mock
    implements _i5.InternetAddressWrapper {
  MockInternetAddressWrapper() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i3.Future<List<_i6.InternetAddress>> lookup(String? host) =>
      (super.noSuchMethod(Invocation.method(#lookup, [host]),
              returnValue: Future<List<_i6.InternetAddress>>.value(
                  <_i6.InternetAddress>[]))
          as _i3.Future<List<_i6.InternetAddress>>);
}
