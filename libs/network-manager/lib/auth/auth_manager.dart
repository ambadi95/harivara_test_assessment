...
abstract class IAuthManager {
  ...
  Future storeJWTToken(String jwtToken);

  Future setUserDetail({String? authInfo, required String key});
...
class AuthManager implements IAuthManager {
  ...
  Future _setJWToken(String jwtToken) async => await _secureStorageService.set(
        _jwtTokenKey,
        jwtToken,
      );
  ...
  //   CrayonPaymentLogger.logInfo("TestSecureStorageData  "+key!.name + "   "+authInfo.toString(),);
  //   await _secureStorageService.set(
  //     key!.name,
  //     authInfo,
  //   );
  ...
  @override
  Future storeJWTToken(
    String jwtToken,
  ) async {
    await _setJWToken(jwtToken);
  }
